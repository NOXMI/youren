package com.noxmi.youren.geocoder;
...
import com.noxmi.youren.util.ThreadUtil;
...
public class ReGeocoderActivity extends Activity implements
    ...
    private final double[] coords = {116.339925, 39.976587,
    ...
    //ReGeocoderActivity(double la,double lon){
    //	this.latLonPoint.setLongitude(lon);
    //	this.latLonPoint.setLatitude(la);
    //}
    @Override
...
//        MapsInitializer.sdcardDir =OffLineMapUtils.getSdCacheDir(this);
    ...
    private void init() {
        ...
        regeoButton.setText("ResGeoCoding(33.975007,120.914932)");
    ...
    private void getAddresses() {
        List<LatLonPoint> geopointlist = new ArrayList<LatLonPoint>();
        geopointlist.add(new LatLonPoint(36.975007, 121.914932));
